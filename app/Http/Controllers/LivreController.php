...
public function store(Request $request) 
       { 
      $livre = new Livre([             'isbn' => $request->input('isbn'),             'titre' => $request->input('titre'),             'annedition' => $request->input('annedition'),             'prix' => $request->input('prix'),             'qtestock' => $request->input('qtestock'),             'couverture' => $request->input('couverture'),             'specialite_id' => $request->input('specialite_id'),             'editeur_id' => $request->input('editeur_id')           
  ]); 
      $livre->save(); 
